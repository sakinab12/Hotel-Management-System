...
<body bgcolor="black">
  <h1 align="center" style="color:black; background-color:orange; font-family: Agency FB; height: 40px; vertical-align: middle;"><b>Book Customer Room</b></h1>
<?php
...
header("location:successnewbooking.php");
}
}
?>
...
<div id="contenar">
	...
	<h2 style="font-family:courier new; color:white ;"> Welcome Admin!</h2>
        <table cellspacing="6">
          <tr>
            <td width="113">Booking Name</td>
            <td width="215">
              <input name="bookingname" size="30" id="bookingname" type="text" placeholder="Enter your name"/></td>
          </tr>
        ...
        <table cellspacing="6">
          <tr>
            <td width="113"></td>
            <td width="215">
    <input name="bookingname" size="10" id="bookingname" type="hidden" value="<?php if(isset($_POST['bookingname'])){ echo $_POST['bookingname']; }?>"/></td>
          </tr>
...
<br>
<div class="t" width="100%" align="center" style="background-color: orange;" ><a href="adminpanal.php"><font size="6" face="Agency FB"><b>GO BACK TO ADMIN PANEL</b></font></a></div>
</body>
</html>
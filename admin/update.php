...
<body bgcolor="black">
  <h1 align="center" style="color:black; background-color:orange; font-family: Agency FB; height: 40px; vertical-align: middle;"><b>Update Customer Booking</b></h1>
<?php
...
?>
	...
	<h3> Booking Updation For <?php  if(isset($_GET['id'])){ echo $room['username']; }  ?> </h3>
        <table cellspacing="6">

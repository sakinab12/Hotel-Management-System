...
<p style="background-color: black; color:white; font-size:30px;position: absolute;top:200px; left:35%; height: 300px; width:500px; opacity: 0.8; border-bottom: solid 10px orange; text-align: center; box-shadow: 0px 0px 8px 5px rgba(0,0,0,0.6);"><br><br>Your FEEDBACK was <span style="color:orange;">REGISTERED</span> <br>successfully! <br><br>THANK YOU for giving us your valuable FEEDBACK , It will help us improve!!</p>

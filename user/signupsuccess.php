...
<p style="background-color: black; color:white; font-size:30px;position: absolute;top:200px; left:35%; height: 300px; width:500px; opacity: 0.8; border-bottom: solid 10px orange; text-align: center; box-shadow: 0px 0px 8px 5px rgba(0,0,0,0.6);"><br><br>You have successfully <span style="color:orange;">REGISTERED</span> <br>to our website!<br><br>Now you can login to book your room!</p>
